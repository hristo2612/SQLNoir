export default [
  ...
  `INSERT INTO surveillance_records (id, person_id, suspicious_activity) VALUES
      (9, 9, 'Requested wake-up call'),
      (10, 10, NULL),
      (11, 11, 'Had breakfast at hotel restaurant'),
      (12, 12, NULL),
      (13, 13, 'Used valet parking'),
      (14, 14, NULL),
      (15, 15, 'Asked for directions to beach'),
      (16, 16, 'Used the business center'),
      (17, 17, NULL),
      (18, 18, 'Requested city map'),
      (19, 19, NULL),
      (20, 20, 'Used concierge service'),
      (34, 34, 'Requested fresh towels'),
      (35, 35, NULL),
      (36, 36, 'Used hotel parking'),
      (37, 37, NULL),
      (38, 38, 'Asked about wifi password'),
      (39, 39, 'Used ice machine'),
      (40, 40, NULL),
      (41, 41, 'Requested extra soap'),
      (42, 42, NULL),
      (43, 43, 'Used hotel phone'),
      (44, 44, NULL),
      (45, 45, 'Asked about check-in time'),
      (46, 46, 'Used lobby restroom'),
      (47, 47, NULL),
      (48, 48, 'Requested room cleaning'),
      (49, 49, NULL),
      (50, 50, 'Used hotel elevator'),
      (51, 51, NULL),
      (52, 52, 'Asked about breakfast hours'),
      (53, 53, 'Used hotel gym'),
      (54, 54, NULL),
      (55, 55, 'Requested extra pillows'),
      (56, 56, NULL),
      (57, 57, 'Used hotel restaurant'),
      (58, 58, NULL),
      (59, 59, 'Asked about local attractions'),
      (60, 60, 'Used vending machine'),
      (61, 61, NULL),
      (62, 62, 'Requested taxi service'),
      (63, 63, NULL),
      (64, 64, 'Used hotel lobby'),
      (65, 65, 'Asked about pool hours'),
      (66, 66, NULL),
      (67, 67, 'Used hotel wifi'),
      (68, 68, NULL),
      (99, 99, NULL),
      (100, 100, 'Used concierge service'),
      (101, 101, 'Asked for room service menu'),
      (102, 102, NULL),
      (103, 103, 'Used the spa facilities'),
      (104, 104, 'Requested late checkout'),
      (105, 105, NULL),
      (106, 106, 'Used the business center'),
      (107, 107, NULL),
      (108, 108, 'Asked about local tours'),
      (109, 109, 'Used the gym'),
      (110, 110, NULL),
      (69, 69, 'Requested room key replacement'),
      (70, 70, NULL),
      (71, 71, 'Used hotel gym'),
      (72, 72, 'Asked about checkout process'),
      (73, 73, NULL),
      (1, 1, 'Requested extra towels'),
      (2, 2, NULL),
      (3, 3, 'Used the hotel gym'),
      (4, 4, 'Ordered room service'),
      (5, 5, NULL),
      (6, 6, 'Spotted entering late at night'),
      (7, 7, 'Seen arguing with an unknown person'),
      (21, 21, NULL),
      (22, 22, 'Borrowed pool towels'),
      (23, 23, 'Asked about checkout time'),
      (24, 24, NULL),
      (25, 25, 'Used hotel wifi'),
      (26, 26, NULL),
      (27, 27, 'Requested newspaper delivery'),
      (28, 28, NULL),
      (29, 29, 'Used hotel restaurant'),
      (30, 30, NULL),
      (31, 31, 'Asked about room service menu'),
      (32, 32, 'Used the elevator'),
      (33, 33, NULL),
      (74, 74, 'Used hotel parking'),
      (75, 75, NULL),
      (76, 76, 'Requested wake-up call'),
      (77, 77, NULL),
      (78, 78, 'Used hotel restaurant'),
      (79, 79, 'Asked about room service'),
      (80, 80, NULL),
      (81, 81, 'Used business center'),
      (82, 82, NULL),
      (83, 83, 'Requested extra towels'),
      (84, 84, NULL),
      (85, 85, 'Used hotel pool'),
      (86, 86, NULL),
      (87, 87, 'Asked about wifi'),
      (88, 88, 'Used valet service'),
      (89, 89, NULL),
      (8, 8, 'Left suddenly at 3 AM'),
      (90, 90, 'Requested room cleaning'),
      (91, 91, NULL),
      (92, 92, 'Used hotel gym'),
      (93, 93, NULL),
      (94, 94, 'Asked about breakfast'),
      (95, 95, NULL),
      (96, 96, 'Used hotel restaurant'),
      (97, 97, NULL),
      (98, 98, 'Requested extra pillows'),
      (111, 111, 'Requested airport shuttle'),
      (112, 112, NULL),
      (113, 113, 'Used room service'),
      (114, 114, NULL),
      (115, 115, 'Asked for extra blankets'),
      (116, 116, 'Used the pool'),
      (117, 117, NULL),
      (118, 118, 'Requested wake-up call'),
      (119, 119, NULL),
      (120, 120, 'Used valet parking'),
      (121, 121, NULL),
      (122, 122, 'Asked about restaurant hours'),
      (123, 123, 'Used the fitness center'),
      (124, 124, NULL),
      (140, 140, NULL),
      (141, 141, 'Used the gym'),
      (142, 142, NULL),
      (143, 143, 'Asked about checkout time'),
      (144, 144, NULL),
      (145, 145, 'Used the pool'),
      (146, 146, 'Requested room service'),
      (147, 147, NULL),
      (148, 148, 'Used valet parking'),
      (149, 149, NULL),
      (150, 150, 'Asked for directions'),
      (151, 151, NULL),
      (152, 152, 'Used the business center'),
      (153, 153, 'Requested wake-up call'),
      (154, 154, NULL),
      (155, 155, 'Used the restaurant'),
      (156, 156, NULL),
      (157, 157, 'Asked about wifi password'),
      (158, 158, NULL),
      (159, 159, 'Used the gym'),
      (160, 160, 'Requested room cleaning'),
      (161, 161, NULL),
      (162, 162, 'Used the spa'),
      (163, 163, NULL),
      (164, 164, 'Asked for extra towels'),
      (165, 165, 'Used room service'),
      (166, 166, NULL),
      (167, 167, 'Requested late checkout'),
      (168, 168, NULL),
      (169, 169, 'Used the conference room'),
      (170, 170, NULL),
      (171, 171, 'Asked about local tours'),
      (172, 172, 'Used the pool'),
      (173, 173, NULL),
      (174, 174, 'Requested airport shuttle'),
      (175, 175, NULL),
      (176, 176, 'Used the fitness center'),
      (177, 177, NULL),
      (178, 178, 'Asked for extra blankets'),
      (179, 179, 'Used valet parking'),
      (125, 125, 'Requested room cleaning'),
      (126, 126, NULL),
      (127, 127, 'Used the conference room'),
      (128, 128, NULL),
      (129, 129, 'Asked for extra towels'),
      (130, 130, NULL),
      (131, 131, 'Used the sauna'),
      (132, 132, 'Requested taxi service'),
      (133, 133, NULL),
      (134, 134, 'Used the bar'),
      (135, 135, NULL),
      (136, 136, 'Asked about local attractions'),
      (137, 137, NULL),
      (138, 138, 'Used room service'),
      (139, 139, 'Requested extra pillows'),
      (180, 180, NULL),
      (181, 181, 'Requested room service'),
      (182, 182, NULL),
      (183, 183, 'Used the sauna'),
      (184, 184, NULL),
      (185, 185, 'Asked about restaurant hours'),
      (186, 186, NULL),
      (187, 187, 'Used the bar'),
      (188, 188, 'Requested taxi service'),
      (189, 189, NULL),
      (190, 190, 'Used the gym'),
      (191, 191, NULL),
      (192, 192, 'Asked for directions'),
      (193, 193, NULL),
      (194, 194, 'Used room service'),
      (195, 195, NULL),
      (196, 196, 'Requested wake-up call'),
      (197, 197, NULL),
      (198, 198, 'Used the business center'),
      (199, 199, NULL),
      (200, 200, 'Asked about checkout time')
    ;`,
